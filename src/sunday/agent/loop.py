        ...
        messages.append(
            {
                ...
                "content": (
                    ...
                    "yours. A 'files touched' note is where a file ended up: "
                    "use those paths when the user says 'it' or 'that file', "
                    "and never read the note aloud. Older entries show what "
