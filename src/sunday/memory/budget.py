...
def slices(cfg: config.Config | None = None) -> Slices:
    ...
    claimants: the system prompt (371 tokens), the bound tool schemas (1552),
    the memory framing block and the standing system lines cost around 2550
    ...
    keeping true. 23552 of window less 2816 of overhead and 768 for the reply
    leaves 19968; the five slices come to 19456, so 512 is slack and every
